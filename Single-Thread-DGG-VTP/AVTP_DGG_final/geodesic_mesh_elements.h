...
public:
	...
	Vertex()
	{
		...
		//m_vertex_sum_angles = new std::vector<double>();
	};
	...
	edge_pointer& edge_start_vertex(){return m_edge_start_vertex;};
	...
	double&     p_start_angle(){ return m_p_start_angle; };
	double& sum_angle_around_v(){ return m_sum_angle_around_v; };
	//std::vector<double>* vertex_sum_angles(){ return m_vertex_sum_angles; };
private:	
	...
	//std::vector<double>* m_vertex_sum_angles;
	...
	edge_pointer   m_edge_start_vertex;
	double         m_p_start_angle;
	double         m_sum_angle_around_v;
...
public:
	...
	std::unordered_map<unsigned int, short int>& face_index_around_vertex(){ return m_face_index_around_vertex; };
private:
	
	std::unordered_map<unsigned int, short int> m_face_index_around_vertex;
