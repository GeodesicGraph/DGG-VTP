#ifndef GEODESIC_CONSTANTS_AND_SIMPLE_FUNCTIONS_H
#define GEODESIC_CONSTANTS_AND_SIMPLE_FUNCTIONS_H
...
int num_propagated_windows_on_thread;
...
inline bool read_mesh_from_file(std::string filename,
								Points& points,
								Faces& faces, 
